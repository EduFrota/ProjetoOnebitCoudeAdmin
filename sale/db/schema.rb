...
ActiveRecord::Schema.define(version: 20180626123933) do
  ...
  create_table "comissions", force: :cascade do |t|
    ...
    t.index ["venda_id"], name: "index_comissions_on_venda_id"
  end
  ...
  create_table "vendas", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["client_id"], name: "index_vendas_on_client_id"
    t.index ["discount_id"], name: "index_vendas_on_discount_id"
